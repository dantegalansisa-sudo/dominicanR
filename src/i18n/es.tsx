...
export const es = {
  ...
  pay: {
    ...
    taxRow: 'Impuestos (5 %)',
    taxNote: 'Solo al pagar con PayPal o tarjeta. En efectivo no se cobran.',
    ...
    cashAmount: (a: number) => `${fmtUsd(a)} en efectivo, sin impuestos`,
    cashHint: 'Reservas ahora y pagas en efectivo (US$) al conductor o al guía. Sin el 5 % de impuestos.',
